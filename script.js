...
function showMessage(response) {
  ...
  if (response === "No") {
    ...
    document.getElementsByClassName("image")[0].src = "images/hamster2.jpg";
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "Yayy!! See you on the 14th Babe!";
    yesMessage.style.display = "block";
    yesMessage.style.fontStyle = "normal";
    document.getElementsByClassName("image")[0].src = "images/hamster3.gif";
